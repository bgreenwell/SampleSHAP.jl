...
"""
    explaincolumn(bst::XGBoost.Booster, X::Matrix, column::Int64, f::Function)

Return TBD.
"""
function explaincolumn(bst::XGBoost.Booster, X::Matrix, column::Int64, f::Function)
  ...
  # Return difference in predictions
  return f(bst, B["b1"]) - f(bst, B["b2"])

end


"""
    explaincolumn(bst::XGBoost.Booster, X::Matrix, column::Int64, newdata::Matrix, f::Function)

Return TBD.
"""
function explaincolumn(bst::XGBoost.Booster, X::Matrix, column::Int64, newdata::Matrix, f::Function)
...
"""
    explain(bst::XGBoost.Booster, X::Matrix, f::Function, nsim::Int64)

Return TBD.
"""
function explain(bst::XGBoost.Booster, X::Matrix, f::Function, nsim::Int64=1)
  res1 = zeros(size(X, 1), nsim)
  res2 = zeros(size(X))
  for i in 1:size(X, 2)
    # println(i)
    for j in 1:nsim
      res1[:, j] = explaincolumn(bst, X, i, f)
    end
    res2[:, i] = Statistics.mean(res1, dims=2)
  end
  res2
...
"""
    explain(bst::XGBoost.Booster, X::Matrix, newdata::Matrix, f::Function, nsim::Int64)

Return TBD.
"""
function explain(bst::XGBoost.Booster, X::Matrix, newdata::Matrix, f::Function, nsim::Int64=1)
  res1 = zeros(size(X, 1), nsim)
  res2 = zeros(size(X))
  for i in 1:size(X, 2)
    # println(i)
    for j in 1:nsim
      res1[:, j] = explaincolumn(bst, X, i, newdata, f)
    end
    res2[:, i] = Statistics.mean(res1, dims=2)
  end
  res2
